                    ...
                    <li>
                        ...
                        if ($upload_foto != "") {
                            ...
                            if ($daftar['status_pendaftaran'] == 1) {
                                ...
                                echo '<font color="#2ecc71">Pas Foto<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akta Kelahiran dan Kartu Keluarga"><i class="fa fa-pencil"></i></a>';
                            }
                        } else {
                            echo 'Upload Pas Foto <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload Akta Kelahiran dan Kartu Keluarga"><i class="fa fa-upload"></i></a>';
                        }
