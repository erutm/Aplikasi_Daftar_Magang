    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="gb">
                <h4 class="title"><b>Upload Surat Pengantar Magang dari Sekolah/Perguruan Tinggi (PDF, JPEG, PNG)</b></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group floating-label" style="margin-left: 20px;">
                            ...
                            <label class="btn btn-warning" for="my-file-selector">
                                ...
                                Upload Surat Pengantar Magang dari Sekolah/Perguruan Tinggi (PDF, JPEG, PNG)
                            </label>
